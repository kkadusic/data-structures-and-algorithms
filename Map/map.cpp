...
string TestBrojElemenata() {
    ...
    m[1] = "Pariz"; m[2] = "London"; m[3] = "New York"; m[4] = "Berlin";
    m.obrisi(2);
    if (m.brojElemenata() != 3) return "Test neuspjesan";
    return "Test uspjesan";
}
...
string TestOperatorDodjele() {
    ...
    m2[0] = "ASP"; m2[1] = "OBP"; m2[3] = "DM";
    m1[0] = "LD"; m1[1] = "RPR"; m1[3] = "SP";
    m1 = m2;
    if (m1[0] != "ASP") return "Test neuspjesan";
    return "Test uspjesan";
}

string TestKopirajuciKonstruktor() {
    NizMapa<int, string> m2;
    m2[0] = "LD"; m2[1] = "RPR"; m2[2] = "SP";
    NizMapa<int, string> m1(m2);
    if (m1.brojElemenata() == 3) return "Test uspjesan";
    return "Test neuspjesan";
}

string TestBrisanje() {
    NizMapa<int, string> m;
    for (int i=0; i<10; i++) m[i] = "Test";
    int pocetniBrojElemenata = m.brojElemenata();
    m.obrisi();
    if (pocetniBrojElemenata == 10 && m.brojElemenata() == 0) return "Test uspjesan";
    return "Test neuspjesan";
}
